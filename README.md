...
Понял! Дополняю твой `README.md` большим справочным блоком по HTML и CSS. Добавляй этот текст после раздела «Как всё устроено» и перед «1. Самая первая заготовка». Получится полноценный учебник.
...
HTML — это скелет страницы. Всё, что ты видишь в браузере, состоит из тегов. Тег пишется в угловых скобках и обычно бывает парным: открывающий `<tag>` и закрывающий `</tag>`. Всё, что между ними — содержимое тега.
